    ...
    <div class="card-body">
        <form action="{{ route('salas.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" id="capacidade" name="capacidade" class="form-control @error('capacidade') is-invalid @enderror" value="{{ old('capacidade') }}" min="1" required>
                @error('capacidade')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="responsavel_nome" name="responsavel_nome" class="form-control @error('responsavel_nome') is-invalid @enderror" value="{{ old('responsavel_nome') }}" required>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" id="responsavel_telefone" name="responsavel_telefone" class="form-control @error('responsavel_telefone') is-invalid @enderror" value="{{ old('responsavel_telefone') }}" maxlength="15" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="email" id="responsavel_email" name="responsavel_email" class="form-control @error('responsavel_email') is-invalid @enderror" value="{{ old('responsavel_email') }}" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="logradouro" name="logradouro" class="form-control @error('logradouro') is-invalid @enderror" value="{{ old('logradouro') }}" required>
                @error('logradouro')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8 mb-3">
                    ...
                    <input type="text" id="complemento" name="complemento" class="form-control @error('complemento') is-invalid @enderror" value="{{ old('complemento') }}">
                    @error('complemento')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" id="cidade" name="cidade" class="form-control @error('cidade') is-invalid @enderror" value="{{ old('cidade') }}" required>
                    @error('cidade')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-2 mb-3">
                    ...
                    <input type="text" id="uf" name="uf" class="form-control @error('uf') is-invalid @enderror" value="{{ old('uf') }}" maxlength="2" required>
                    @error('uf')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="mb-3">
                ...
                <select id="status" name="status" class="form-select @error('status') is-invalid @enderror" required>
                    ...
                    <option value="indisponivel" @selected(old('status') === 'indisponivel')>Indisponível</option>
                    <option value="manutencao" @selected(old('status') === 'manutencao')>Manutenção</option>
                </select>
                @error('status')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
